...
export default function Project() {
    const [nav1,
    setNav1]=useState(null);
    const [nav2,
    setNav2]=useState(null);

    const projectCard=(image, title, cardClass, usedTechnologies, onClickLink)=>(<div className= {
            cardClass
        }
        ...
        alt=""/> <h3> {
            ...
            usedTechnologies && (<div className="usedTechnologies"> {
                    usedTechnologies.map((tech, index)=> (<span key= {
                                index
                            }
        ...
        <div className="overlay"></div> <a className='viewButton'href= {
            onClickLink
        }
    ...
    return (<section className='project'id='project'> <div className="container slide-in-top"> <div className="sectionHead"> <h2>Projects</h2> </div> <Slider {
            ...settings1
        }
