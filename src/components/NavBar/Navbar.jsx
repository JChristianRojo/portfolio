            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="desktopMenu">
                        <Link onClick={() => scrollWithOffset("#about")} className='desktopMenuListItem'>About Me</Link>
                        <Link onClick={() => scrollWithOffset("#project")} className='desktopMenuListItem'>Projects</Link>
                    </div>
