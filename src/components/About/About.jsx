...
<section className="about" id="about">
    <div className="container">
        ...
        <p>
            I am a passionate <strong>Software Developer</strong> with over a year of experience in web development, specializing in creating <strong>user-friendly</strong> and <strong>visually engaging web solutions</strong>. Throughout my career, I have collaborated with UI/UX designers to develop scalable applications, enhance website performance, and build <strong>custom WordPress themes and plugins</strong>. My expertise spans various platforms, including <strong>WordPress</strong>, <strong>Shopify</strong>, and <strong>Squarespace</strong>, with a strong emphasis on <strong>SEO optimization</strong> and <strong>responsive design</strong>. My work primarily focuses on <strong>creating WordPress themes from scratch</strong>, ensuring they are both user-friendly and aligned with <strong>modern frameworks</strong> and <strong>advanced technologies</strong> to elevate user experiences.
        </p>
        <p>
            I earned a <strong>Bachelor of Science degree in Computer Engineering</strong> in 2022, balancing my academic journey with <strong>six years as a dedicated student-athlete</strong> and <strong>three years as a student leader</strong>.
        </p>
